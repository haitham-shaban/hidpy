function stacks=simStacks(emitter_position, frames,Optics,Cam,Fluo,Grid,intensity_peak_mode,tutorial)
...
[grid,stacks.analog]=simStacksCore(emitter_position, frames,Optics,Cam,Fluo,Grid,intensity_peak_mode,tutorial);
